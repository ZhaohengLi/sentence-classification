...
class ClassificationBase(object):
    """
    Base class for all sentence classification data sets. This is an abstract class.
    """
    ...
    def __init__(self, ext_vocab=None, key_name=None):
        super().__init__()
    ...
    def vocab_list(self):
        """
        list: valid vocab list, equals to ``all_vocab_list[：valid_vocab_len]``.
        Read only.
        :return:
        """
